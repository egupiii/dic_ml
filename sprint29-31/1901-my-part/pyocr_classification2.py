...
class classify_products:
    ...
    def preprocessing(self):
        ...
        list_str = [STR_POCARI, STR_CALPIS, STR_ILOHAS_NORMAL,
                    STR_ILOHAS_PEACH, STR_TROPICANA]
...
#         results_pyocr.append(list(txt_gray))
#         results_pyocr.append(list(txt_blur))
#         results_pyocr.append(list(txt_th1))
